...
final class DescriptionLeatherCaseViewController: UIViewController {
    
    //MARK: - View
    let titleLabel = UILabel().titleLabel()
    let macImage = UIImageView().imageProduct("caseBlack")
    ...
    private let leftButton = UIButton().changeLeftButton(#colorLiteral(red: 0.573803255, green: 0.2738095238, blue: 0.08306760204, alpha: 1))
...
//MARK: - Private Init
extension DescriptionLeatherCaseViewController {
    ...
    @objc func isActivLeft() {
        ...
        //
        macImage.image = UIImage(named: "caseBrown")
    ...
    @objc func isActivRight() {
        ...
        //
        macImage.image = UIImage(named: "caseBlack")
        macImage.layer.cornerRadius = 10
        macImage.clipsToBounds = true
    ...
    //MARK: - GestureWEB
    @objc func nextWeb() {
        let wkWeb = WKWebLeatherViewController()
