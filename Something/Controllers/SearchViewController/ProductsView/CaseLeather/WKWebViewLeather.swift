...
final class WKWebLeatherViewController: UIViewController {
...
//MARK: - Private Init
extension WKWebLeatherViewController {
    ...
    private func loadRequest() {
        guard let url = URL(string: "https://www.apple.com/ru/macbook-pro-14-and-16/") else {return}
