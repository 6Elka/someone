...
final class DescriptionStrapViewController: UIViewController {
    
    //MARK: - View
    let titleLabel = UILabel().titleLabel()
    let macImage = UIImageView().imageProduct("grayStrap")
    ...
    private let leftButton = UIButton().changeLeftButton(#colorLiteral(red: 0.5681166053, green: 0.6003970504, blue: 0.9854136109, alpha: 1))
...
//MARK: - Private Init
extension DescriptionStrapViewController {
    ...
    @objc func isActivLeft() {
        ...
        //
        macImage.image = UIImage(named: "pinkStrap")
    ...
    @objc func isActivRight() {
        ...
        //
        macImage.image = UIImage(named: "grayStrap")
        macImage.layer.cornerRadius = 10
        macImage.clipsToBounds = true
    ...
    //MARK: - GestureWEB
    @objc func nextWeb() {
        let wkWeb = WebStrapViewController()
