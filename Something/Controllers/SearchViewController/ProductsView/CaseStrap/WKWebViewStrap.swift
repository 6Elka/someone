...
final class WebStrapViewController: UIViewController {
...
//MARK: - Private Init
extension WebStrapViewController {
    ...
    private func loadRequest() {
        guard let url = URL(string: "https://www.apple.com/ru/apple-watch-series-7/") else {return}
